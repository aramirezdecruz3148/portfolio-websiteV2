...
export default function PortfolioCards() {
  ...
  return (
    ...
    >
      ...
      />
      <CardContent>
        <p className={styles.caption}> A directory containing all characters and spells within the Harry
            Potter universe. Click below to view the deployed app or click the
            expand icon for project details and tech.</p>
      </CardContent>
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          ...
          <Typography className={spacing.h5} variant='h5'>TECH</Typography>
          <Typography paragraph variant='body1' className={spacing.body1}>• JavaScript Components</Typography>
          <Typography paragraph variant='body1' className={spacing.body1}>• HTML/CSS</Typography>
          <Typography paragraph variant='body1' className={spacing.body1}>• Harry Potter API</Typography>
        </CardContent>
      </Collapse>
    </Card>
  );
